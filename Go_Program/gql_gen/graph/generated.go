...
func (ec *executionContext) field_Mutation_createLink_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewLink2myᚑgqlgenᚑappᚋgraphᚋmodelᚐNewLink(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_createUser_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewUser2myᚑgqlgenᚑappᚋgraphᚋmodelᚐNewUser(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_login_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNLogin2myᚑgqlgenᚑappᚋgraphᚋmodelᚐLogin(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_refreshToken_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNRefreshTokenInput2myᚑgqlgenᚑappᚋgraphᚋmodelᚐRefreshTokenInput(ctx, tmp)
	}
...
func (ec *executionContext) _Link_user(ctx context.Context, field graphql.CollectedField, obj *model.Link) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖmyᚑgqlgenᚑappᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_createLink(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNLink2ᚖmyᚑgqlgenᚑappᚋgraphᚋmodelᚐLink(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_links(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Link)
	fc.Result = res
	return ec.marshalNLink2ᚕᚖmyᚑgqlgenᚑappᚋgraphᚋmodelᚐLinkᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNLink2myᚑgqlgenᚑappᚋgraphᚋmodelᚐLink(ctx context.Context, sel ast.SelectionSet, v model.Link) graphql.Marshaler {
	return ec._Link(ctx, sel, &v)
}

func (ec *executionContext) marshalNLink2ᚕᚖmyᚑgqlgenᚑappᚋgraphᚋmodelᚐLinkᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Link) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNLink2ᚖmyᚑgqlgenᚑappᚋgraphᚋmodelᚐLink(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNLink2ᚖmyᚑgqlgenᚑappᚋgraphᚋmodelᚐLink(ctx context.Context, sel ast.SelectionSet, v *model.Link) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNLogin2myᚑgqlgenᚑappᚋgraphᚋmodelᚐLogin(ctx context.Context, v any) (model.Login, error) {
	res, err := ec.unmarshalInputLogin(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNNewLink2myᚑgqlgenᚑappᚋgraphᚋmodelᚐNewLink(ctx context.Context, v any) (model.NewLink, error) {
	res, err := ec.unmarshalInputNewLink(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNNewUser2myᚑgqlgenᚑappᚋgraphᚋmodelᚐNewUser(ctx context.Context, v any) (model.NewUser, error) {
	res, err := ec.unmarshalInputNewUser(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNRefreshTokenInput2myᚑgqlgenᚑappᚋgraphᚋmodelᚐRefreshTokenInput(ctx context.Context, v any) (model.RefreshTokenInput, error) {
...
func (ec *executionContext) marshalNUser2ᚖmyᚑgqlgenᚑappᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
